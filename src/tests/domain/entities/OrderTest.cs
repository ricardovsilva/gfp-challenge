...
namespace tests.domain.entities
{
    ...
    public class OrderTest
    {
        ...
        [TestMethod]
        public void AddDish_DrinkMultipleTimesAtNight_RaiseInvalidOrderException()
        {
        ...
        [TestMethod]
        public void AddDish_DessertAtMorning_RaiseInvalidOrderException()
        {
            var order = new Order(TimeOfDay.MORNING);
        ...
        [TestMethod()]
        public void AddDish_EntreeMultipleTimesAtAnyTimeOfDay_RaiseInvalidOrderException()
        {
            var order = new Order(TimeOfDay.MORNING);
            order.AddDish(DishTypes.ENTREE);
        ...
        [TestMethod]
        public void AddDish_SideMultipleTimesAtAnyTimeOfDay_RaiseInvalidOrderException()
        {
            var order = new Order(TimeOfDay.MORNING);
            order.AddDish(DishTypes.SIDE);
        ...
        [TestMethod]
        public void AddDish_DessertMultipleTimesAtNight_RaiseInvalidOrderException()
        {
            var order = new Order(TimeOfDay.MORNING);
